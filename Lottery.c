...
void main()
{
  int WinLotteryNo[12] = {1522, 1711, 5515, 7233, 5614, 8876, 1215, 4232, 9155, 9995,8545,7454};
  float WinAmount[12] = {5000000, 10000, 10000, 5000, 5000, 5000, 5000, 3000, 3000, 3000,3000,3000};
  int N = 12;
  int i, won;
