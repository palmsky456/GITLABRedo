...
void main()
{
  char Name[100][40] = {"Sam Matthews", "Mary McBeth", "Ying Phakpon","Chai Chanchai", "Yong Boonsith", "Kitti Karndee", "PalmSkee Love Si"};
  int ID[100] = {5301, 5302, 5303, 5304, 5305, 5306};
